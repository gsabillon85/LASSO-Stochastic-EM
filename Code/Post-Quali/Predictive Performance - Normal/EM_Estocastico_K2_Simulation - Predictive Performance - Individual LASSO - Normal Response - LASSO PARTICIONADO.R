...
mainDir = paste("/home/gustavo/Projects/LASSO-NHMM/Code/Post-Quali/Predictive Performance - Normal/Individual LASSO Results/K2/",cenario,sep = "")
...
for (p in 1:R){
  ...
  for (h in 1:length(lambdas)){
    for (w in 1:length(lambdas)){
      ...
      lasso_lambdas[lasso_iterator, ] <- c(h,w)
