...
for (p in 1:length(lambdas)){
  ...
  for (h in 1:length(seeds)){
    ...
    mu = c(50,150,250) # vetor com media para as duas Normais
    sigma = c(0.75,1,1.25) #Vetor com os desvios padrões para as duas normais
    mu_hat <- NULL
    sigma_hat <- NULL
